...
import { ICustomersResponse, ICustomerUpd,ICustomer, ICustomerNew } from "../abstraction/Interfazes/ICustomers";
...
export async function CreateCustomer(customer: any): Promise<ICustomerNew> {
  try {
