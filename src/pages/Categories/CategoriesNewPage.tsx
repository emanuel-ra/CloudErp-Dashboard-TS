  ...
  const handleCreate = async (event: React.FormEvent<HTMLFormElement>) => {
    try {
      ...
      const formData = {
        ...
        isEnableEccomerce: event.currentTarget["IsEnableEccomercer"].checked
          ? 1
          : 0,
        ...
        <div className="flex justify-center">
          <div className="grid gap-4 mb-4 grid-cols-2">
            <div className="col-span-2">
              <LabelInp>Nombre</LabelInp>
              <InputModalL name={"Nombre"}></InputModalL>
            </div>
            <div className="col-span-2 ">
              <LabelInp>Logo</LabelInp>
              <InputModalL name={"Logo"}></InputModalL>
            </div>
