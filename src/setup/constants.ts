...
export const ENDPOINT_PRODUCTS_STORE = import.meta.env
  .VITE_ENDPOINT_PRODUCTS_STORE;

export const ENDPOINT_USOCFDI = import.meta.env.VITE_ENDPOINT_USOCFDI;
export const ENDPOINT_REGIMENFISCAL = import.meta.env
  .VITE_ENDPOINT_REGIMENFISCAL;
